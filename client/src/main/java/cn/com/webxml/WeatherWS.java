 ...
 * 2018-06-23T17:49:50.465+08:00
 * Generated source version: 3.0.9
 * 
 */
@WebServiceClient(name = "WeatherWS", 
                  wsdlLocation = "file:WeatherWS.asmx",
...
public class WeatherWS extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:WeatherWS.asmx");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherWS.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:WeatherWS.asmx");
        }
        WSDL_LOCATION = url;
    }
